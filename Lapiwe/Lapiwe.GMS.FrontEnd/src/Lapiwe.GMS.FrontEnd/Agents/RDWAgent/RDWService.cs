...
namespace Lapiwe.GMS.FrontEnd.Agents.RDWAgent
{
    ...
    /// <summary>
    /// A RESTfull service for RDW keuringverzoeken
    /// </summary>
    public partial class RDWService : ServiceClient<RDWService>, IRDWService
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the RDWService class.
        /// </summary>
        /// <param name='handlers'>
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public RDWService(params DelegatingHandler[] handlers) : base(handlers)
        {
            this.Initialize();
        }
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public RDWService(HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : base(rootHandler, handlers)
        {
            this.Initialize();
        }
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public RDWService(Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public RDWService(Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new ArgumentNullException("baseUri");
        ...
        /// </return>
        public async Task<HttpOperationResponse> VerzoekWithHttpMessagesAsync(KeuringsVerzoekCommand keuringsVerzoekCommand = default(KeuringsVerzoekCommand), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("keuringsVerzoekCommand", keuringsVerzoekCommand);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "Verzoek", tracingParameters);
            }
            // Construct URL
            var _baseUrl = this.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/Keuring").ToString();
            ...
            if(keuringsVerzoekCommand != null)
            {
                _requestContent = SafeJsonConvert.SerializeObject(keuringsVerzoekCommand, this.SerializationSettings);
